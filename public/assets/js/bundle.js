...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  gerarSenha.addEventListener('click', function (e) {
    senhaGerada.innerHTML = gera();
  });
});
function gera() {
  return (0,_geradores__WEBPACK_IMPORTED_MODULE_0__.geraSenha)(qtdCaracteres.value, chkMaiusculas.checked, chkMinusculas.checked, chkNumeros.checked, chkSimbolos.checked) || 'Caracteres não determinado.';
}
